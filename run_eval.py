...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset", type=str, default="soccer", help="soccer or basketball dataset"
    )
    parser.add_argument(
        "--pred",
        type=str,
        default="detections/pipeline_soccer_result.json",
        help="prediction json path with COCO result format",
    )
    parser.add_argument(
        "--anno",
        type=str,
        default="annotations/soccer_groundtruth.json",
